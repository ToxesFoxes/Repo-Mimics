...
namespace TFS_Mimics
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            #region General
            configVoiceVolume = /*                 */ Config.Bind("General", "Volume", /*                          */ 30, /*    */ new ConfigDescription("Volume of mimic voices (percent).", new AcceptableValueRange<int>(0, 100), Array.Empty<object>()));
            ...
            configMinDelay = /*                    */ Config.Bind("General", "MinDelay", /*                        */ 10, /*    */ new ConfigDescription("Minimum delay before record/play.", new AcceptableValueRange<int>(5, 300), Array.Empty<object>()));
            configMaxDelay = /*                    */ Config.Bind("General", "MaxDelay", /*                        */ 20, /*    */ new ConfigDescription("Maximum delay before record/play.", new AcceptableValueRange<int>(10, 600), Array.Empty<object>()));
